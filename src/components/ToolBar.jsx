...
export default function ToolBar({cart, emptyCart}){
  const navigate = useNavigate();
    return(
    <nav className="navbar sticky-top navbar-light bg-body-tertiary" aria-label="Offcanvas navbar large">
        <div className="container-fluid">
              ...
              <ul className="ms-auto mb-2 mb-lg-0"> 
                <div className="dropstart nav-item">
                  ...
                  <ul className="dropdown-menu">
                    <li><Cart cart={cart} emptyCart={emptyCart} className="dropdown-item"/></li>
                  </ul>
              </div>
          </ul>
          ...
          <div className="offcanvas offcanvas-end text-bg-light" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div className="offcanvas-header">
              <h5 className="offcanvas-title" id="offcanvasNavbarLabel">MikroHome</h5>
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li className="nav-item">
                  <Link to="/" style={{textDecoration: "none", color:"black"}} className="nav-link active" aria-current="page">Home</Link>
                </li>
                <li className="nav-item">
              ...
              <form className="d-flex mt-3 mt-lg-0" role="search">
                ...
                <button className="nav-item btn btn-outline-danger" onClick={()=>{
