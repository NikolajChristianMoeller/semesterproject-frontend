  ...
  function showFeedback(res, type) {
    ...
    if (res) {
      switch (type) {
        case (type = "delete"):
          document
            .querySelector("#feedback-delete-success")
        ...
        case (type = "update"):
          document
            .querySelector("#feedback-update-success")
            .classList.remove("hidden");
          setTimeout(() => {
            document
              .querySelector("#feedback-update-success")
        ...
        case (type = "create"):
          document
            .querySelector("#feedback-create-success")
            .classList.remove("hidden");
          setTimeout(() => {
            document
              .querySelector("#feedback-create-success")
        ...
        default:
          document
            .querySelector("#feedback-success")
            .classList.remove("hidden");
          setTimeout(() => {
      ...
      switch (type) {
        case (type = "delete"):
          document
            .querySelector("#feedback-delete-error")
            .classList.remove("hidden");
          setTimeout(() => {
            document
              .querySelector("#feedback-delete-error")
        ...
        case (type = "create"):
          document
            .querySelector("#feedback-create-error")
            .classList.remove("hidden");
          setTimeout(() => {
            document
              .querySelector("#feedback-create-error")
        ...
        case (type = "update"):
          document
            .querySelector("#feedback-update-error")
            .classList.remove("hidden");
          setTimeout(() => {
            document
              .querySelector("#feedback-update-error")
  ...
  return (
    <div>
      ...
      <div id="tabs" className="container row mt-4 mx-auto">
        <ul className="nav-tabs nav">
          <li className="nav-item" style={{ cursor: "pointer" }}>
            <p
              id="product-tab"
              data-tab-show="product-list"
              onClick={(event) => tabs(event)}
              className="nav-link"
            >
              Products
            </p>
          ...
          <li className="nav-item" style={{ cursor: "pointer" }}>
            <p
              id="collection-tab"
              data-tab-show="collections-list"
              onClick={(event) => tabs(event)}
              className="nav-link"
            >
              Collections
          ...
          <button
            className="nav-item btn btn-info ms-2"
            type="button"
      ...
      <UpdateForm
        ...
        handleUpdate={handleUpdate}
        createOptionClick={createOptionClick}
        colors={colors}
